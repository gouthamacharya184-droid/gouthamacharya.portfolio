          ...
          <div className="grid gap-6 xs:gap-8 md:gap-10 grid-cols-1 md:grid-cols-[0.45fr_0.55fr]">
            ...
            <div className="space-y-6 xs:space-y-8">
              ...
              <div className="p-4 xs:p-6 rounded-xl xs:rounded-2xl bg-gradient-to-br from-cyan-500/8 to-transparent border border-cyan-500/10">
                ...
                <p className="text-xs xs:text-sm text-slate-400 leading-relaxed italic">This project demonstrates a structured approach to problem-solving in the AI domain, focusing on data reliability and high-quality model outputs.</p>
              </div>
            </div>
          </div>
        )}
